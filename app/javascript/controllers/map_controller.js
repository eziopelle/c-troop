...
export default class extends Controller {
  ...
  direction(event) {
    ...
    fetch(`https://api.mapbox.com/directions/v5/mapbox/cycling/${this.userLong},${this.userLat};${markerlng},${markerlat}?steps=true&geometries=geojson&access_token=${this.apiKeyValue}`,
      { method: 'GET' }
    )
